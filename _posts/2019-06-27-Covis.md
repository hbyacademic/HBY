...
- modification for some files
    - <font color="#dd0000"> add  #include <stdlib.h> at the top of the following two files <br>
    (~/vsfm/pba/src/pba/SparseBundleCU.h and ~/vsfm/pba/src/pba/pba.h) </font>
...
- modification for some files
    - <font color="#dd0000"> add #include <vector> and #include <numeric> at the top of the file (~/vsfm/cmvs/program/base/cmvs/bundle.cc) </font>
