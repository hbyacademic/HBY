...
- modification for some files
    - add  __#include <stdlib.h>__ at the top of the following two files <br>
...
- modification for some files
    - add #include <vector> and #include <numeric> at the top of the file (~/vsfm/cmvs/program/base/cmvs/bundle.cc) </font>
