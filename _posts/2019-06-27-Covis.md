...
- **modification for some files**
    ...
    - in the file cmvs/program/main/genOption.cc <br>
      1. #Your INCLUDE path (e.g., -I/usr/include)
      2. #YOUR_INCLUDE_PATH = 
      3. #Your metis directory (contains header files under graclus1.2/metisLib/)
      4. #Your LDLIBRARY path (e.g., -L/usr/lib)
      5. YOUR_INCLUDE_METIS_PATH = -I/home/scott/vsfm/graclus1.2/metisLib
      6. YOUR_LDLIB_PATH = -L/home/scott/vsfm/graclus1.2
    - you can also copy and paste the command below
