...
<font color="#dd0000">It is one of the linear classifier which has linear decision bounderies. </font> A linear classifier provides multiple linear equations to divide the classes into several regions. <br>
