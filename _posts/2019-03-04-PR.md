...
Here is the classification result with 5% of dataset for training and three features involved. The gray plane is the decision boundary. It gives the classification accuracy round to 96%. That is, only 4% of the testing data are misclassified.
<p align="center">
