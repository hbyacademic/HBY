...
After several adjustments for the weight vector, it generated the final decision boundary which is w<sub>1</sub>x + w<sub>2</sub>y + w<sub>3</sub>z + w<sub>4</sub>a + w5 = 0 
