...
It is one of <font color="#dd0000">the linear classifier which has linear decision bounderies.</font> A linear classifier provides multiple linear equations to divide the classes into several regions. <br>
...
Here is the classification result with 90% of dataset for training and three features involved. The gray plane is the decision boundary. It gives the classification accuracy round to 96%. That is, only 4% of the testing data are misclassified.
<p align="center">
