...
Typically, each instance is represented by a feature vector. An instance contains four features, which can be written as a row vector  [atrb1,atrb2,atrb3,atrb4]   
~~~
