...
In conclusion, a perception classifier generates multiple linear decision boundaries. Each misclassified instance leads to one update of linear decision boundary. Please refer to the following codes.
