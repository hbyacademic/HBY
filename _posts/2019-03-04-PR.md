...
Here is the classification result with 90% of dataset for training and three features involved. It gives the classification accuracy round to 96%. The gray plane is the decision boundary. 
<p align="center">
